...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_SITE_URL}/og-image/og-image-contact.png`,
        width: 1200,
        height: 630,
...
export default function ContactPage() {
  return (
    <section className="overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-10 max-w-5xl mx-auto px-4 py-12 md:py-20">
              ...
              <div className="flex gap-4">
                <div>
                  <Button variant="outline" size="icon" asChild>
                    <Link href="https://instagram.com/adxxya30" target="_blank">
                ...
                <div>
                  <Button variant="outline" size="icon" asChild>
                    <Link href="https://facebook.com/adxxya30" target="_blank">
                ...
                <div>
                  <Button variant="outline" size="icon" asChild>
                    <Link href="https://github.com/AdityaZxxx" target="_blank">
